...
def crear_tag_con_numero(nombre, numero_favorito):
    ...
    """
    user_name = nombre[:5]
    numero_favorito = input("Ingrese numero favorito: ")
    return user_name, numero_favorito


tag_con_numero = crear_tag_con_numero("Kkjnc")
print(f"{tag_con_numero}", numero_favorito)