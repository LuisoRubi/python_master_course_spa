...
def crear_tag_invertido(nombre):
    ...
    """
    tag_invertido = nombre[::-1] #recorre el texto de uno en uno hacia atrás
    return tag_invertido
...
def crear_tag_intercalado(nombre, apellido):
    ...
    print("3. TAG INTERCALADO: ", primer_letra_nombre, primer_letra_apellido, restante_nombre, restante_apellido, sep="")
...
def crear_tag_elite(nombre):
    ...
    # tag_elite = first_letters, last_letters
    # return tag_elite
    print("4. TAG ELITE: ", first_letters, last_letters, sep="")
...
def crear_tag_con_numero(nombre, numero_favorito):
    ...
    # tag_con_numero = user_name, fav_num
    # return tag_con_numero
    print("5. TAG CON NÚMERO: ", user_name, fav_num, sep="")
...
def mostrar_opciones(): # Aquí puedo construir una función que me ayude a tener mejor organizado y mostrar los prints e invocar funciones debidamente
    pass
