...
def crear_tag_intercalado(nombre, apellido):
    ...
    tag_intercalado = primer_letra_nombre, primer_letra_apellido, restante_nombre, restante_apellido
    return tag_intercalado
...
def crear_tag_con_numero(nombre, numero_favorito):
    ...
    return print(tag_con_numero, sep="")
...
print(f"3. TAG INTERCALADO: {crear_tag_intercalado(nombre, apellido)}", sep="")
